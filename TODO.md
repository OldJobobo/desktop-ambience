...
- [ ] Add more configurable ambience animations and weather styles:
  ...
  - [x] **Precipitation styles** — Rainfall selects bounded rain or snow renderers while preserving shared intensity, speed, direction, theme blending, persistence, and reduced-motion behavior. See [`docs/precipitation-styles-plan.md`](docs/precipitation-styles-plan.md).
