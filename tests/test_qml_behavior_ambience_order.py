      ...
      onTriggered: {{
        ...
        Qt.callLater(function() {{
          console.log("BEHAVE " + JSON.stringify({{
            ...
            firstExists: host.firstIdentity !== null,
            secondExists: host.secondIdentity !== null,
...
'''
        ...
        self.assertTrue(row["firstExists"], output[-2000:])
        self.assertTrue(row["secondExists"], output[-2000:])
